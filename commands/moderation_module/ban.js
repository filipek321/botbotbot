...
module.exports.run = async (bot, message, args) => {
    ...
    if (!bUser) return message.channel.send("Podaj nick.").then(msg => msg.delete(10000));
    let bReason = args.join(" ").slice(22);
    if (!bReason) return message.channel.send("Proszę podać powód.").then(msg => msg.delete(10000));
