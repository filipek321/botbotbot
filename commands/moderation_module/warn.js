...
module.exports.run = async (bot, message, args) => {
    ...
    if (!wUser) return message.reply("Brak użytkownika.").then(msg => msg.delete(5000));
    if (wUser.hasPermission("MANAGE_MESSAGES")) return message.reply("Za duża ranga").then(msg => msg.delete(5000));
